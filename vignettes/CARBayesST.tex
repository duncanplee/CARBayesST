...
Then version 3.0.1 has fixed a bug with the print function.
}
...
R>  pairs(pollutionhealthdata[ ,c(9, 5:7)], pch=19, cex=0.5, lower.panel=NULL, 
+       panel=panel.smooth,
